...
public class ComprobanteController {
    ...
    @PostMapping("/create")
    public ResponseEntity<?> add(@Valid @RequestBody ComprobanteEntity comprobanteEntity) {
    ...
    public ResponseEntity<?> delete(@PathVariable String id) throws ClassNotFoundException,IllegalArgumentException,Exception {
        ...
        return httpStatus(HttpStatus.BAD_REQUEST, String.format("Comprobante with id '%s' deleted successfully",id));
    } 
